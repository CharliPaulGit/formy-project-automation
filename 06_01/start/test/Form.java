...
public class Form {
    public static void main(String[] args) {
        ...
        driver.findElement(By.id("first-name")).sendKeys("Charli");
        driver.findElement(By.id("last-name")).sendKeys("Paul");
        driver.findElement(By.id("job-title")).sendKeys("QA Lead");
        driver.findElement(By.id("radio-button-2")).click();
        driver.findElement(By.id("checkbox-2")).click();
        driver.findElement(By.cssSelector("option[value='4']"));
        driver.findElement(By.id("datepicker")).sendKeys("05/05/2022");
